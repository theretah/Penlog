...
namespace Penlog.Data.Migrations
{
    ...
    [Migration("20230928200931_addPreviewPhotoFieldToPosts")]
    partial class addPreviewPhotoFieldToPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Penlog.Model.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Penlog.Model.Entities.Post", b =>
                {
                    ...
                    b.HasIndex("PreviewPhotoId")
                        .IsUnique()
                        .HasFilter("[PreviewPhotoId] IS NOT NULL");
            ...
            modelBuilder.Entity("Penlog.Model.Entities.Photo", b =>
                {
                    b.HasOne("Penlog.Model.Entities.AppUser", "User")
                        ...
                        .HasForeignKey("Penlog.Model.Entities.Photo", "UserId");
            ...
            modelBuilder.Entity("Penlog.Model.Entities.Post", b =>
                {
                    ...
                    b.HasOne("Penlog.Model.Entities.Photo", "PreviewPhoto")
                        .WithOne("Post")
                        .HasForeignKey("Penlog.Model.Entities.Post", "PreviewPhotoId");
